...
remap('', '<leader>gv', '<Esc>:Gvdiffsplit!<CR>',   { noremap = true })
...
remap('', '<leader>gl', '<Esc>:Git log --graph --abbrev-commit --decorate<CR>',      { noremap = true })
-- remap('', '<leader>gt', '<Esc>:Git tag -n<CR>',      { noremap = true })
-- remap('', '<leader>gt', '<Esc>:Git tag --format='%(creatordate:short)%09%(refname:strip=2)' --sort=-creatordate<CR>',      { noremap = true })
remap('', '<leader>sr', '<Esc>:Git rebase -i HEAD~10<CR>',      { noremap = true })

-- choosing on diff when rebasing
remap('', '<leader>gh', '<Esc>:diffget //3<CR>',      { noremap = true })
remap('', '<leader>gf', '<Esc>:diffget //2<CR>',      { noremap = true })
