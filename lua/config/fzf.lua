...
fzf_lua.setup {
  ...
  files = {
    ...
    multiprocess      = true,
    debug             = false,
    cmd           = "rg --files --column --line-number --no-heading --color=always --smart-case --no-ignore --hidden -g '!{**/.zinit/*,go/pkg/*,**/.npm/*,**/.rvm/*,**/.node-gyp/*,**/.git/*,**/.tox/*,**/venv/*,**/.venv/*,.pyenv/*,*.pyi,*.pyc,__pycache__/*,.cache/*}' 2> /dev/null",
  },
  grep = {
    prompt            = 'Rg❯ ',
    input_prompt      = 'Grep For❯ ',
    rg_opts           = "--column --line-number --no-heading --color=always --smart-case --no-ignore --hidden -g '!{**/.zinit/*,go/pkg/*,**/.npm/*,**/.rvm/*,**/.node-gyp/*,**/.git/*,**/.tox/*,**/venv/*,**/.venv/*,.pyenv/*,*.pyi,*.pyc,__pycache__/*,.cache/*}' 2> /dev/null",
...
-- map_fzf('n', '<leader>sx', "command_history")
